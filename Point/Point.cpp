...
int APIENTRY _tWinMain(_In_ HINSTANCE hInstance,
    ...
    LoadString(hInstance, IDC_POINT, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_POINT));
...
ATOM MyRegisterClass(HINSTANCE hInstance) {
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_POINT));
